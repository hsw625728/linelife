...
@interface FWLockPatternCollectionViewCell ()
...
@implementation FWLockPatternCollectionViewCell
...
- (void)layoutSubviews
{
    ...
    self.titleBar.frame = CGRectMake(
            0,
            self.contentView.bounds.size.height - [FWLockPatternCollectionViewCell titleBarHeight],
            self.contentView.bounds.size.width,
            [FWLockPatternCollectionViewCell titleBarHeight]
    );
    ...
    self.lockButton.frame = CGRectMake(
...
- (void)lockButtonTapped:(UIButton *)sender
{
    ...
    [((FWPatternPickerViewController*)self.delegate) presentViewController:viewController animated:YES completion:nil];
